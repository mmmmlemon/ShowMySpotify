<?php
    ...
    class System
    {
        //checkSpotifyAccessToken (DEPRECATED)
        ...
        //setAccessToken
        //установить access token для работы Spotify Web API
        //параметры: реквест
        //возвращает либо true (если токен установлен), либо false (если ошибка)
        public static function setAccessToken($request){
            //берем Spotify access token из куки
            $spotifyAccessToken = $request->cookie('spotify_access_token');
